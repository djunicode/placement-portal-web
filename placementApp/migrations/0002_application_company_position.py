# Generated by Django 3.0.3 on 2020-03-16 10:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('1', 'Schedule Interview'), ('2', 'Put Under Review'), ('3', 'Selected'), ('4', 'Rejected')], default='1', max_length=1)),
